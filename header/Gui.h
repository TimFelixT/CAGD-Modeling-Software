...
private:
    ...
    void OnDerivativeToggle(const JSObject&, const JSArgs&);
    void OnDerivativeTChange(const JSObject&, const JSArgs&);
    ...
    void OnToggleSurfaceControlStructure(const JSObject& thisObject, const JSArgs& args);
